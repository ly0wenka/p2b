...
namespace DGP.Util.Collections
{
    ...
    public class SerializableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        [SerializeField] protected List<TKey> _keys;

        [SerializeField] protected List<TValue> _values;
        ...
        {
            get { return new List<TKey>(this._keys); }
        }

        public virtual ICollection<TValue> Values
        {
            get { return new List<TValue>(this._values); }
        }
