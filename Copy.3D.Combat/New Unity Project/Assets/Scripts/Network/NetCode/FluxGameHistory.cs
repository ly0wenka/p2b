...
public class FluxGameHistory
{
    ...
    public long Count
    {
        get { return this._history.Count; }
    }
    ...
    {
        get { return this.FirstStoredFrame + this._history.Count - 1; }
    }
    ...
    protected List<KeyValuePair<FluxStates, FluxFrameInput>> _history =
        new List<KeyValuePair<FluxStates, FluxFrameInput>>();
