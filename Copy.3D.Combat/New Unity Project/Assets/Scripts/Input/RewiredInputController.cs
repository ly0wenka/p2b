...
public sealed class RewiredInputController : AbstractInputController
{
    ...
    {
        get { return _inputSource ?? (_inputSource = new UnityInputSource()); }
        set { _inputSource = value; }
    }

    public static ITouchInputUI touchInputUI
    {
        get { return _touchInputUI; }
        set { _touchInputUI = value; }
    }
    ...
    {
        public float GetAxis(int playerId, string name) => Input.GetAxis(name);

        public float GetAxisRaw(int playerId, string name) => Input.GetAxisRaw(name);

        public bool GetButton(int playerId, string name) => Input.GetButton(name);
    }
