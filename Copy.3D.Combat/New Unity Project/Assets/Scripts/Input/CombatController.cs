...
public class CombatController : AbstractInputController
{
    ...
    {
        get { return this._cpuController; }
        set
        {
    ...
    {
        get { return this._humanController; }
        set
        {
    ...
    public override void DoFixedUpdate()
    {
        if (this.inputReferences != null)
        {
            ...
            //---------------------------------------------------------------------------------------------------------
            if (this.cpuController != null && this.isCPU && MainScript.gameRunning && !MainScript.isPaused())
            {
    ...
    protected bool UseHumanController(InputReferences inputReference)
    {
        return
            ...
            (
                !(this.isCPU && MainScript.gameRunning)
                ||
                MainScript.isPaused()
                ||
